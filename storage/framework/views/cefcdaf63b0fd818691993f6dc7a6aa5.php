      ...
      <div class="space-y-4">
        ...
        <template x-if="sessionDone">
          <div class="rounded-2xl bg-emerald-50 border border-emerald-200 p-5">
            ...
            <a href="<?php echo e(route('leaderboard.spelling')); ?>" class="inline-block mt-2 px-4 py-2 rounded-full bg-emerald-600 text-white hover:bg-emerald-700">Lihat Leaderboard</a>
          </div>
        </template>
      </div>
    </div>
...
function spellingGame(){
  return {
    ...
    nextRound(){
      ...
      fetch('<?php echo e(route('spelling.new')); ?>',{method:'POST', headers:{
        'X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>','Content-Type':'application/json'
    ...
    submit(){
      fetch('<?php echo e(route('spelling.answer')); ?>',{method:'POST', headers:{
        'X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>','Content-Type':'application/json'
    ...
    finishSession(){
      ...
      fetch('<?php echo e(route('spelling.finish')); ?>',{method:'POST', headers:{
        'X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>','Content-Type':'application/json'
...
<?php endif; ?>
<?php /**PATH C:\Users\Adam\Documents\Kuliah\semester 7\capstone\englishedu\resources\views/spelling/index.blade.php ENDPATH**/ ?>